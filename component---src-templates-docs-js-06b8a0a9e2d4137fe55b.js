...
function (_React$PureComponent) {
  ...
  function MainContent(props) {
    ...
    _this.convertFilename = function (filename) {
      var pathname = _this.props.location.pathname;

      if (Object(components_utils["d" /* isZhCN */])(pathname) && !filename.includes('-cn')) {
        return filename + "-cn";
      }
    ...
    _this.generateMenuItem = function (_ref2, item) {
      ...
      var child = !item.link ? external_React_default.a.createElement(gatsby_browser_entry["a" /* Link */], {
        to: _this.convertFilename(item.filename),
        disabled: disabled
    ...
    _this.getMenuItems = function (footerNavIcons) {
      ...
      var result = [].concat(topLevel, subMenu).filter(function (_ref3) {
        var key = _ref3.key;
        return key;
      });
      return result;
...
//# sourceMappingURL=component---src-templates-docs-js-06b8a0a9e2d4137fe55b.js.map