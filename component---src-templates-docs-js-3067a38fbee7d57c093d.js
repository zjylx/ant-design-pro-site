...
/* harmony import */ var _babel_runtime_helpers_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(77);
...
/* harmony import */ var _components_layout__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(382);
/* harmony import */ var _components_Content_MainContent__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(383);
/* harmony import */ var _components_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(170);
...
function Template(_ref) {
  var data = _ref.data,
      rest = _babel_runtime_helpers_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_1___default()(_ref, ["data"]);
  ...
  var menuList = edges.map(function (_ref2) {
    var node = _ref2.node;
    var newFrontmatter = Object(_components_utils__WEBPACK_IMPORTED_MODULE_5__[/* transformerFrontmatter */ "f"])(node.frontmatter);
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_layout__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], rest, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_Content_MainContent__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"], Object.assign({}, rest, {
    localizedPageData: {
      meta: Object.assign({}, Object(_components_utils__WEBPACK_IMPORTED_MODULE_5__[/* transformerFrontmatter */ "f"])(frontmatter), {
...
function (_React$PureComponent) {
  ...
  function MainContent(props) {
    ...
    _this.getMenuItems = function (footerNavIcons) {
      ...
      var moduleData = getModuleDataWithProps(_this.props);
      var locale = _this.context.intl.locale;
   ...
   * @param {string} url
   * @return {Promise}
   * @see {@link https://docs.alipay.com/mini/api/ui-navigate#a-name730dvoamynavigateto}
   */
  MainContent.navigateTo = function navigateTo(url) {
    if (url === '/pages/index/index') {
      return this.switchTab('/pages/home');
    }

    var urlParse = parseUrl(url);
    var pages = getCurrentPages();
    var beyond = pages && pages.length >= 5;
    return new Promise(function (resolve, reject) {
      myjs[beyond ? 'redirectTo' : 'navigateTo']({
        url: url.indexOf('/') === 0 ? urlParse : "/" + urlParse,
        success: resolve,
        fail: reject
      });
    });
   ...
   * @return {Promise}
   * @see {@link https://docs.alipay.com/mini/api/ui-tabbar#a-nameg12hstamyswitchtab}
   */
  ;

  MainContent.switchTab = function switchTab(url) {
    return new Promise(function (resolve, reject) {
      myjs.switchTab({
...
//# sourceMappingURL=component---src-templates-docs-js-3067a38fbee7d57c093d.js.map